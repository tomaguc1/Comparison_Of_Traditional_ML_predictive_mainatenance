...
# hyperPar_x = [np.arange(2, 30, 3), 'Max Depth']
# hyperPar_y = [np.arange(10,50, 9), 'No_Estimators']

hyperPar_x = [np.arange(17, 22, 1), 'Max Depth']
hyperPar_y = [np.arange(13, 23, 2), 'No_Estimators']
