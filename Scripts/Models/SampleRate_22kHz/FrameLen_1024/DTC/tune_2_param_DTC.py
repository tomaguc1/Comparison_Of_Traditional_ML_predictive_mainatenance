...
# hyperPar_x = [np.arange(2, 25, 4), 'Minimum_Sample_Split']
# hyperPar_y = [np.arange(5, 40, 5), 'Max_Depth']

hyperPar_x = [np.arange(10, 23, 3), 'Minimum_Sample_Split']
hyperPar_y = [np.arange(11, 18, 2), 'Max_Depth']
