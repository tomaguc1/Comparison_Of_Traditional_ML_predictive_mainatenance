...
# hyperPar_x = [np.arange(5, 100, 9), 'Minimum_Sample_Split']
# hyperPar_y = [np.arange(2, 60, 7), 'No_Estimators']


hyperPar_x = [np.arange(25, 35, 2), 'Minimum_Sample_Split']
hyperPar_y = [np.arange(7, 16, 1), 'No_Estimators']
