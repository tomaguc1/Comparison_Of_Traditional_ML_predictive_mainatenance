...
plot(lambdas[best_lambda_idx], error_list[best_lambda_idx], 'o', markersize= 8, markerfacecolor= 'none', markeredgecolor= 'firebrick', markeredgewidth= 2, label= f'Lamda = {best_lambda} : Error = {round(error_list[best_lambda_idx], 3)}')
...
title('Hyperparam tuning for logireg 22kHz')
